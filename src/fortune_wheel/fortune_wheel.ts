...
wheelCallbacks.addEventListener("beforeOutfitEquip", MBS_REGISTRATION_DATA, {
...
wheelCallbacks.addEventListener("color", MBS_REGISTRATION_DATA, {
    callback: ({ character, newAsset }, _cache) => {
        ...
        if (indices) {
            ...
            return Array(newAsset.ColorableLayerCount).fill(cache.hairColor);
        }
    },
    id: "copyHairColor",
    description: "Copy the character's hair color to a number of items",
    conditional: true,
});
...
wheelCallbacks.addEventListener("typeRecord", MBS_REGISTRATION_DATA, {
    ...
    id: "randomizeType",
    description: "Randomize the (extended item) type of specified items",
    conditional: true,
    defaultKwargs: { groupNames: Object.freeze(new Set as Set<AssetGroupName>) },
});
    ...
    waitFor(settingsMBSLoaded).then(() => {
        ...
        FORTUNE_WHEEL_ITEM_SETS = Object.freeze([
            ...
            new FWItemSet(
                ...
                [
                    { mod: "MBS", listener: "color", id: "copyHairColor" },
                    {
                        ...
                        listener: "typeRecord",
                        id: "randomizeType",
                        kwargs: { groupNames: new Set(["ItemLegs", "ItemFeet", "ItemArms", "ItemMouth2", "ItemMouth3"]) },
                    },
                ],
            ),
            new FWItemSet(
            ...
            new FWItemSet(
                ...
                undefined,
                [
                    { mod: "MBS", listener: "beforeOutfitEquip", id: "statueSetBodyColor" },
                ],
            ),
        ]);
