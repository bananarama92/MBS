...
import { sortBy, omit, clamp, sample, pick } from "lodash-es";
...
export class FWItemSet extends FWObject<FWItemSetOption> implements Omit<FWSimpleItemSet, "flags"> {
    ...
    readonly activeHooks: readonly FWHook[];
    ...
    constructor(
        ...
        this.activeHooks = kwargs.activeHooks;
    }
    ...
    static validate(kwargs: FWItemSetKwargTypes): Required<FWItemSetKwargTypes> {
        ...
        if (!isArray(kwargs.activeHooks)) {
            kwargs.activeHooks = [];
        } else {
            kwargs.activeHooks = kwargs.activeHooks.map(i => {
                return (
                    typeof i === "object"
                    && i !== null
                    && typeof i.id === "string"
                    && typeof i.listener === "string"
                    && typeof i.mod === "string"
                    && (i.kwargs === undefined || (typeof i.kwargs === "object" && i.kwargs !== null))
                ) ? pick(i, "id", "listener", "mod", "kwargs") : null as never;
            }).filter(Boolean);
        }
     ...
     */
    scriptFactory(flag: FWFlag, hooks: readonly FWHook[]): (character?: null | Character) => void {
