...
class JSON {
    ...
    #gagData: Readonly<Record<string, GagData>> = Object.freeze({});
    ...
    get gagData() {
        if (!this.#gagDataInit) {
            this.#setField("gagData", "https://bananarama92.github.io/MBS/main/vendor/gag_data.json");
        }
        return this.#gagData;
    }
    ...
    get phoneticDict() {
        if (!this.#phoneticDictInit) {
            this.#setField("phoneticDict", "https://bananarama92.github.io/MBS/main/vendor/en_UK.json");
        }
