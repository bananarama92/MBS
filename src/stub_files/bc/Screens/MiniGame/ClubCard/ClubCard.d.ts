 ...
 */
declare function ClubCardNameIsOnBoard(Board: any[], CardName: any): boolean;
/**
 ...
 */
declare function ClubCardGroupIsOnBoard(Board: any[], CardGroup: any): boolean;
/**
 ...
 */
declare function ClubCardGroupOnBoardCount(Board: any[], CardGroup: any): number;
/**
 ...
 * @returns {void} - Nothing
 */
declare function ClubCardRemoveFromBoard(Board: any[], Card: ClubCard): void;
/**
 ...
 * @returns {void} - Nothing
 */
declare function ClubCardRemoveGroupFromBoard(Board: any[], GroupName: string): void;
/**
