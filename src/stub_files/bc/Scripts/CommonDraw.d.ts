 ...
 */
declare function CommonDrawFindPose(C: Character, AllowedPoses: readonly AssetPoseName[]): AssetPoseName;
/**
 ...
 */
declare function CommonDrawResolveAssetPose(C: Character, A: Asset, Layer?: AssetLayer): AssetPoseName;
